# La technologie de la santé en République centrafricaine : défis et opportunités pour le HMS dans les contextes post-conflit

**Meta Description:** Une évaluation honnête de la santé numérique en République centrafricaine — les défis du déploiement d'un HMS en État fragile, les projets pilotes menés par les ONG et le long chemin vers le redressement du système de santé.

**Target Keywords:** système de gestion hospitalière République centrafricaine, santé numérique RCA Bangui, HMS États fragiles Afrique, technologie de la santé RCA, OpenMRS Afrique centrale, logiciel de santé CEMAC post-conflit, santé numérique Centrafrique

---

## La République centrafricaine : les soins de santé dans l'un des États les plus fragiles du monde
