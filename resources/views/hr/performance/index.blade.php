<x-layouts.hr title="Performance Reviews">
@php $locale = app()->getLocale(); @endphp

<div class="cp-page-header">
    <div>
        <h1 class="cp-page-title">Performance Reviews</h1>
        <p class="cp-page-subtitle">{{ $reviews->total() }} reviews across all departments</p>
    </div>
</div>
...
<div class="cp-section-grid">
    ...
    <div class="cp-section-card" style="grid-column:1/-1">
        <div class="cp-section-header">
            <h2 class="cp-section-title"><i data-lucide="star" style="width:17px;height:17px;color:#8B5CF6"></i> All Reviews</h2>
        </div>
        ...
        <form method="GET" class="portal-filter-bar">
            ...
            <input type="text" name="period" value="{{ request('period') }}" placeholder="Period (e.g. Q2 2026)">
        ...
        <table class="portal-table">
            <thead>
                <tr><th>Employee</th><th>Reviewer</th><th>Period</th><th>Date</th><th>Rating</th><th>Status</th></tr>
            </thead>
            <tbody>
    ...
    <div class="cp-section-card">
        <div class="cp-section-header">
            <h2 class="cp-section-title"><i data-lucide="plus-circle" style="width:17px;height:17px;color:#8B5CF6"></i> Initiate Review</h2>
        </div>
        <form method="POST" action="{{ route('hr.performance.store', ['locale' => $locale]) }}" class="cp-form">
            @csrf
            <div style="display:flex;flex-direction:column;gap:.875rem">
                ...
                <button type="submit" class="cp-btn-primary" style="align-self:flex-start">
                    <i data-lucide="plus" style="width:15px;height:15px"></i> Create Review
                </button>
            </div>
        </form>
    </div>
