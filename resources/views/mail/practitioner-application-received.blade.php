...
<div class="wrap">
    <div class="header">
        <p class="header-title">Application Received</p>
        <p class="header-sub">OPES Practitioner Programme</p>
    </div>
    <div class="body">
        <p class="hi">Hi {{ $application->practitioner->name }},</p>
        <p class="intro">
            We have received your application for the programme below. Our team will review it and get back to you as soon as possible.
        </p>
