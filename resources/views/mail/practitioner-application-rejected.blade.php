...
<div class="wrap">
    <div class="header">
        <p class="header-title">Update on Your Application</p>
        <p class="header-sub">OPES Practitioner Programme</p>
    </div>
    <div class="body">
        <p class="hi">Dear {{ $application->practitioner->name }},</p>
        <p class="intro">
            Thank you for applying to the programme below. After careful review, we are unable to accept your application at this time. We appreciate your interest and encourage you to apply again in the future.
        </p>
        ...
        <a href="{{ config('app.url') }}/en/practitioner/programs" class="cta">View Other Programmes</a>
